document.addEventListener("DOMContentLoaded", () => {
  ...
  // Only allow simple .md filenames — reject path traversal / weird input
  if (postFile && /^[A-Za-z0-9._-]+\.md$/.test(postFile)) {
...
async function loadBlogPost(filename) {
  ...
  container.innerHTML =
    '<div class="blog-loading"><span class="loading-dot"></span><span class="loading-dot"></span><span class="loading-dot"></span><span style="margin-left:.5rem;">loading post&hellip;</span></div>';
  ...
  try {
    ...
    if (typeof hljs !== "undefined") {
      document
        .querySelectorAll(".prose pre code")
  ...
  frontMatter.split("\n").forEach((line) => {
    ...
    if (key && valueParts.length > 0) {
      ...
      if (value.startsWith("[") && value.endsWith("]")) {
        ...
        // Strip surrounding quotes from scalars (e.g., title: "Foo")
