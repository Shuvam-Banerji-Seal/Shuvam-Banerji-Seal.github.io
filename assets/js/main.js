...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function toggleTheme() {
    const currentTheme =
      ...
      "light";
    const nextTheme = isDarkTheme(currentTheme)
      ? "light"
      : getRandomDarkTheme();
  ...
  // Toggle navbar background on scroll (guarded — #navbar is injected
  // dynamically by navbar.js; never crash if it is absent).
  if (navbar) {
